    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="<?php echo e(route("admin.hotels.create")); ?>">
                <?php echo e(trans('global.add')); ?> <?php echo e(trans('cruds.hotel.title_singular')); ?>
...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('cruds.hotel.title_singular')); ?> <?php echo e(trans('global.list')); ?>
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Hotel">
                <thead>
                    <tr>
                        ...
                        <th>
                            <?php echo e(trans('cruds.hotel.fields.photo')); ?>
                        ...
                        <th>
                            <?php echo e(trans('cruds.hotel.fields.rating')); ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $hotels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $hotel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($hotel->id); ?>">
                            <td>
                            ...
                            <td>
                                <?php if($hotel->photo): ?>
                                    <a href="<?php echo e($hotel->photo->getUrl()); ?>" target="_blank">
                                        <img src="<?php echo e($hotel->photo->getUrl('thumb')); ?>" width="50px" height="50px">
                                    </a>
                                <?php endif; ?>
                            </td>
                            <td>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('hotel_delete')): ?>
  ...
  let deleteButton = {
    ...
    url: "<?php echo e(route('admin.hotels.massDestroy')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\Proyectos-Jobaca\landing-1\resources\views/admin/hotels/index.blade.php ENDPATH**/ ?>